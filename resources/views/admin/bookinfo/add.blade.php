...
<form name="main_form" method="POST" action="{{ url('bookinfo') }}" enctype="multipart/form-data" >
	{{csrf_field()}}
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="book_writer" value="" required="required">
                </td>
            </tr>
            <tr>
                <td class="label">出版商：</td>
                <td>
                    <input type="text" name="book_publisher" value="" required="required">
                </td>
            </tr>
            <tr>
                <td class="label">ISBN：</td>
                <td>
                    <input type="text" name="book_ISBN" value="" required="required">
                </td>
            </tr>
            <tr>
                <td class="label">开本：</td>
                <td>
                    <input type="text" name="book_format" value="" required="required">
                </td>
            </tr>
            <tr>
                <td class="label">字数：</td>
                <td>
                    <input type="text" name="book_words_num" value="">字
                </td>
            </tr>
            <tr>
                <td class="label">页数：</td>
                <td>
                    <input type="text" name="book_page_num" value="" required="required">页
                </td>
            </tr>
            <tr>
                <td class="label">出版日期：</td>
                <td>
                    <input type="text" name="book_publication_data" value=""><span>格式：1990-09-01</span>
                </td>
            </tr>
            <tr>
                <td class="label">印刷日期：</td>
                <td>
                    <input type="text" name="book_print_data" value=""><span>格式：1990-09-01</span>
                </td>
            </tr>
            <tr>
